...
<body style="background-color: rgb(192, 219, 247); font-family: Georgia, Arial, sans-serif">
    <div style="max-width: 750px; background: #ffffff; margin: 20px auto; padding: 35px; border-radius: 16px; border : 2px solid #031344">
        ...
        <div style="max-width: 750px; margin: 0 auto; padding: 0 35px;">
            ...
            <a href="{{ route('wishlists.index') }} "><button style="padding: 8px 12px; cursor: pointer; min-height: 36px; vertical-align: top;">💖 Halaman Wishlist</button></a>
            <a href="{{ route('reviews.create') }}"><button style="padding: 8px 12px; cursor: pointer;">⭐ Berikan Review</button></a>
            <a href="{{ route('notifications.index') }}"><button style="padding: 8px 12px; cursor: pointer;">🔔 Notifikasi</button></a>
            <a href="{{ route('promotions.index') }}"><button style="padding: 8px 12px; cursor: pointer;">📢 Daftar Promo</button></a>
            <br><br>
