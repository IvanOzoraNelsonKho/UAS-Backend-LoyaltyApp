...
<body style="background-color: rgb(192, 219, 247); font-family: Georgia, Arial, sans-serif; margin: 20px;">
    ...
    <div style="margin-bottom: 20px; text-align: center; display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="{{ route('redemptions.index') }}"><button style="background-color: #e9ecef; cursor: pointer; padding: 10px 15px; font-weight: bold; border-radius: 6px;">🎁 Kelola Redemption</button></a>
        <a href="{{ route('merchants.index') }}"><button style="background-color: #e9ecef; cursor: pointer; padding: 10px 15px; font-weight: bold; border-radius: 6px;">🏪 Kelola Merchant</button></a>
        <a href="{{ url('/vouchers') }}"><button style="background-color: #e9ecef; cursor: pointer; padding: 10px 15px; font-weight: bold; border-radius: 6px;">🎟️ Kelola Voucher</button></a>
    </div>
